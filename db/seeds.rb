...
groups = Group.create([{name: 'Greater Southwest Development Corporation', website: 'www.greatersouthwest.org', contact_info: '(773)436-1000', address: '2601 W. 63rd St.'}, {name: 'Inner-City Muslim Action Network', website: 'http://www.imancentral.org/', contact_info: '(773)434-4626', address: '2744 W. 63rd St., Chicago, IL 60629'}, {name: 'Metropolitan Family Services', website: 'https://www.metrofamily.org/', contact_info: '(312)986-4000', address: 'One North Dearborn, Suite 1000, Chicago, IL 60602'}])
...
m_rep_event = Event.create([{group_rep_id: m_rep.id, name: "Test Uptown Rep Event", organizer_contact_info: m_rep.email, event_time: Faker::Time.forward(28, :morning), is_free: true, location: "6700 S. Kedzie Ave."}])
m_admin_event = Event.create([{group_rep_id: m_admin.id, name: "Test Uptown Admin Event", organizer_contact_info: m_admin.email, event_time: Faker::Time.forward(28, :morning), is_free: true, location: m_admin.group.address}])
